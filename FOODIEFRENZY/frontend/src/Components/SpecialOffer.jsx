    ...
    <div className="bg-gradient-to-b from-[#1a1212] to-[#2a1e1e] text-white py-16 px-4 font-[Poppins]">
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-14">
          ...
          <p className="text-lg text-gray-300 max-w-3xl mx-auto tracking-wide lending-relaxed">
                  ...
                  <div className="relative h-72 overflow-hidden">
                    ...
                    <div className="absolute bottom-4 left-4 right-4 flex justify-between items-center bg-black/40 backdrop-blur-sm px-4 py-2 rounded-full">
                      <span className="flex items-center gap-2 text-amber-400">
                        <FaStar className="text-xl drop-shadow-[0_2px_2px_rgba(0,0,0,0.8)]"></FaStar>
                        <span className="font-bold">{item.rating}</span>
                      </span>
                      <span className="flex items-center gap-2 text-red-400">
                        <FaHeart className="text-xl animate-heartbeat"></FaHeart>
                    ...
                    <div className="flex items-center justify-between gap-4">
                      ...
                      {cartItem ? (
                        <div className="flex items-center gap-3">
                          ...
                          >
                            {" "}
                            <HiMinusSm className="w-4 h-4 text-amber-100"></HiMinusSm>{" "}
                          </button>
                          ...
                          >
                            {" "}
                            <HiPlus className="w-4 h-4 text-amber-100"></HiPlus>{" "}
                          </button>
                        </div>
                      ) : (
                        <button
