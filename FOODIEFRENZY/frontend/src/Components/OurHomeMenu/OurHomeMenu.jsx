...
import { dummyMenuData } from "../../../public/FOODIE-FRENZY-FINAL/OmhDD";
    ...
    <div className="bg-gradient-to-br from-[#1a120b] via-[#2a1e14] to-[#3e2b1d] min-h-screen py-16 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex justify-center mt-16">
          <Link
            to="/menu"
            className="bg-amber-900 border-2 border-amber-800/30 text-amber-100 px-8 sm:px-10 py-3 rounded-full font-cinzel uppercase tracking-widest  transition-all duration-300 hover:bg-amber-800/40 hover:text-amber-50 hover:scale-105 hover:shadow-lg hover:shadow-amber-900/20 backdrop-blur-sm "
          >
            Explore Full Menu
          </Link>
        </div>
