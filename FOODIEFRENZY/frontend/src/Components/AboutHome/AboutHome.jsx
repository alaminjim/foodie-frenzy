...
import { aboutfeature } from "../../../public/FOODIE-FRENZY-FINAL/dummydata";
import { FaInfoCircle } from "react-icons/fa";
import AboutImage from "../../../public/FOODIE-FRENZY-FINAL/AboutImage.png";
    ...
    <div className="min-h-screen bg-gradient-to-br from-[#0f0a0a] via-[#1a1212] to-[#2a1e1e] text-white py-10 sm:py-20 relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 flex flex-col lg:flex-row items-center lg:gap-8 xl:gap-16 relative">
        <div className="w-full order-1 lg:order-2 space-y-8 sm:space-y-12 relative">
          <div className="space-y-4 md:space-y-8 px-4 sm:px-0">
            ...
            <p className="text-base sm:text-lg md:text-xl opacity-90 leading-relaxed max-w-3xl font-serif italic border-l-4 bg-amber-500/60 pl-4 sm:py-2 bg-gradient-to-r from-white/5 to-transparent">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-8 px-4 sm:px-0">
            {aboutfeature.map((item, i) => (
              ...
              >
                ...
                >
                  <item.icon className="text-2xl sm:text-3xl text-white"></item.icon>
                </div>
          ...
          <div className="flex flex-wrap gap-4 items-center mt-6 sm:mt-8 px-4 sm:px-0">
            ...
            >
              ...
              <FaInfoCircle className="text-lg sm:text-xl animate-pulse"></FaInfoCircle>
        ...
        <div className="w-full order-2 lg:order-1 md:max-w-md lg:max-w-none lg:w-7/12 mb-10 mt-12 lg:mb-0 relative group transform hover:scale-[1.01] transition-all duration-500">
          <div className="relative rounded-[4rem] overflow-hidden border-4 border-amber-900/30 hover:border-amber-500/20 duration-500 shadow-2xl shadow-black/50">
            ...
            <div className="absolute -bottom-12 left-1/2 -transition-x-1/2 w-4/5 h-16 bg-amber-900/30 blur-3xl z-0" />
          </div>
          <div className="absolute -top-6 -right-6 w-24 h-24 bg-amber-900/30 blur-xl"></div>
        </div>
      </div>
