      ...
      >
        <div className="max-w-4xl mx-auto">
          ...
          <motion.p initial={{ opacity: 0 }} animate={{ opacity: 1 }}>
            Crafting unforgettable dining experienced delivered to your
            doorstep.
          </motion.p>
        </div>
      </motion.section>
              ...
              >
                ...
                <div className="relative bg-[#3c2a21]/90 backdrop-blur-lg rounded-3xl overflow-hidden border border-amber-600/30 hover:border-amber-500 transition-all duration-300 h-full ">
                  ...
                  <div className="p-8">
                    ...
                    >
                      <Icon className="w-12 h-12 text-amber-500"></Icon>
                    </motion.div>
          ...
          {stats.map((s, i) => {
            ...
            return (
              <motion.div
                ...
                animate={{
                  scale: hoverStat === i ? 1.05 : 1,
                  zIndex: hoverStat === i ? 10 : 1,
                }}
              ...
              >
                ...
                >
                  <div className="relative h-full bg-[#3c2a21]/40 backdrop-blur-lg rounded-xl border-2 border-amber-600/30 p-6 overflow-hidden transition-all duration-300">
                    <div className="absolute inset-0 rounded-xl shadow-lg shadow-amber-900/20"></div>
                    <div className="relative z-20 h-full flex flex-col items-center justify-center">
                      <motion.div
                        className="mb-3 p-3 rounded-full bg-amber-900/30 border border-amber-700/30"
                      ...
                      <motion.div
                        className="text-xm uppercase tracking-widest font-medium text-amber-100/80"
                        animate={{
                          letterSpacing: hoverStat === i ? "0.15em" : "0.1em",
                          textShadow:
                            hoverStat === i
                    ...
                    <motion.div
                      ...
                      initial={{ opacity: 0 }}
                      animate={{ opacity: hoverStat === i ? 1 : 0 }}
                    />
                  </div>
                </motion.div>
                <motion.div
                  ...
                  animate={{
                    opacity: hoverStat === i ? 0.4 : 0.2,
                    scale: hoverStat === i ? 0.9 : 0.8,
                  }}
                />
              </motion.div>
            );
