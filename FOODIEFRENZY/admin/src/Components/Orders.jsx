  ...
  if (loading)
    return (
      <div className={layoutClasses.page + "flex items-center justify-center"}>
        <div className="text-amber-400 text-xl">Loading Order.....</div>
      </div>
    );
    ...
    <div className={layoutClasses.page}>
      <div className="max-w-7xl mx-auto">
        <div className={layoutClasses.card}>
                    ...
                    <tr key={order._id} className={tableClasses.row}>
                      ...
                      <td className={tableClasses.cellBase}>
                        <div className="flex items-center gap-2">
                          <FiUser className="text-amber-400"></FiUser>
                          <div>
                      ...
                      <td className={tableClasses.cellBase + "text-center"}>
                        <div className="flex items-center justify-center gap-1">
                          <FiBox className="text-amber-400"></FiBox>
                      ...
                      <td
                        className={
                          tableClasses.cellBase + "text-amber-400 text-lg"
                        }
                      >
          ...
          {orders.length === 0 && (
            <div className="text-center py-12 text-amber-100/80 text-xl">
              No Orders Found
            </div>
          )}
        </div>
